...
const LUMO_ANOMALY_TOOL = "lumo_detect_anomaly";
const ANOMALY_TIMEOUT_MS = 700;

export type { AnomalyDetectionResult, DetectAnomalyInput, MetricPointInput } from "./anomaly-detection-core.js";

export async function detectMetricAnomalies(args: {
  user_id: string;
...
async function recordAnomalyUsage(args: {
  user_id: string;
  ok: boolean;
