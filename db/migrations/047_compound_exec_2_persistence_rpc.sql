-- COMPOUND-EXEC-2 persistence RPC.
--
-- Rollback:
--   revoke execute on function public.create_compound_transaction_from_graph(jsonb) from service_role;
--   drop function if exists public.create_compound_transaction_from_graph(jsonb);
--
